            ...
            <table className="w-full text-xs">
              <thead>
                <tr className="bg-gray-200">
                  <th className="border border-gray-300 px-2 py-1 text-center">出庫</th>
                  <th className="border border-gray-300 px-2 py-1 text-center">Girls</th>
                  <th className="border border-gray-300 px-2 py-1 text-center">時間</th>
                  ...
                  <th className="border border-gray-300 px-2 py-1 text-center">JMTドライバー統計</th>
                  <th className="border border-gray-300 px-2 py-1 text-center">次の予約1</th>
                  <th className="border border-gray-300 px-2 py-1 text-center">次の予約2</th>
                  <th className="border border-gray-300 px-2 py-1 text-center">次の予約3</th>
                  <th className="border border-gray-300 px-2 py-1 text-center">次の予約4</th>
                  <th className="border border-gray-300 px-2 py-1 text-center">予約51分後</th>
                  <th className="border border-gray-300 px-2 py-1 text-center">出席記録書</th>
                  <th className="border border-gray-300 px-2 py-1 text-center">持込配車票</th>
